...
export const DEFAULT_OBJECT_DATA_TEMPLATES: ObjectDataTemplateSettings = {
  ...
  types: {
    intersection: buildTemplateType(
      ...
      ['intersection'],
      [
        { id: 'general', label: 'Thông tin chung', order: 10 },
        { id: 'network', label: 'Kết nối', order: 20 },
      ],
      [
        { key: 'intersection_code', label: 'Mã nút giao', type: 'text', groupId: 'general', order: 10, showInPalette: true, showInAnalysis: true },
        { key: 'junction_scope', label: 'Phạm vi nút giao', type: 'text', groupId: 'general', order: 20, showInPalette: true, showInAnalysis: true },
        { key: 'traffic_role', label: 'Vai trò', type: 'select', groupId: 'network', order: 10, showInPalette: true, showInAnalysis: true, options: ['primary', 'secondary', 'shared'] },
      ],
    ),
    camera: buildTemplateType(
      ...
      [
        { id: 'general', label: 'Thông tin chung', order: 10 },
        { id: 'specs', label: 'Thông số kỹ thuật', order: 20 },
      ],
      [
        { key: 'camera_code', label: 'Mã camera', type: 'text', groupId: 'general', order: 10, showInPalette: true, showInAnalysis: true },
        { key: 'vendor', label: 'Nhà cung cấp', type: 'text', groupId: 'general', order: 20, showInPalette: true, showInAnalysis: true },
        { key: 'model', label: 'Model', type: 'text', groupId: 'general', order: 30, showInPalette: true, showInAnalysis: true },
        { key: 'mount_height', label: 'Chiều cao lắp đặt', type: 'number', groupId: 'specs', order: 10, showInPalette: true, showInAnalysis: true, defaultValue: 0 },
        { key: 'focal_length_mm', label: 'Tiêu cự (mm)', type: 'number', groupId: 'specs', order: 20, showInPalette: true, showInAnalysis: true, defaultValue: 0 },
        { key: 'sensor_size', label: 'Cảm biến', type: 'text', groupId: 'specs', order: 30, showInPalette: true, showInAnalysis: true },
        { key: 'resolution', label: 'Độ phân giải', type: 'text', groupId: 'specs', order: 40, showInPalette: true, showInAnalysis: true },
      ],
    ),
    line: buildTemplateType(
      ...
      [
        { id: 'general', label: 'Thông tin chung', order: 10 },
        { id: 'cable', label: 'Thông số cáp', order: 20 },
      ],
      [
        { key: 'line_code', label: 'Mã tuyến', type: 'text', groupId: 'general', order: 10, showInPalette: true, showInAnalysis: true },
        { key: 'line_role', label: 'Vai trò', type: 'select', groupId: 'general', order: 20, showInPalette: true, showInAnalysis: true, options: ['backbone', 'access', 'link'] },
        { key: 'cable_type', label: 'Loại cáp', type: 'text', groupId: 'cable', order: 10, showInPalette: true, showInAnalysis: true },
        { key: 'core_count', label: 'Số lõi', type: 'number', groupId: 'cable', order: 20, showInPalette: true, showInAnalysis: true, defaultValue: 0 },
        { key: 'bandwidth', label: 'Băng thông', type: 'text', groupId: 'cable', order: 30, showInPalette: true, showInAnalysis: true },
      ],
    ),
  },
};
