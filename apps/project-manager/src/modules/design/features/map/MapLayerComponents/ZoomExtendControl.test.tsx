...
describe('ZoomExtendControl', () => {
    beforeEach(() => {
        ...
        mockMapState.map.isStyleLoaded.mockReturnValue(true);
    ...
    it('does not fit bounds before the map style is ready', async () => {
        mockMapState.map.isStyleLoaded.mockReturnValue(false);
        useDesignSync.setState({
            state: mapStateWithFeatures(),
            projectId: 'project-1',
            zoomExtendTrigger: 1,
