...
import type { MapBasemapPreset } from '../useMapStyles';
...
export const createRasterStyle = (tileUrls: string[]): maplibregl.StyleSpecification => ({
    version: 8,
    sources: {
        [BASEMAP_SOURCE_ID]: {
            type: 'raster',
...
export const updateRasterSourceTiles = (map: maplibregl.Map, sourceId: string, tileUrls: string[]) => {
