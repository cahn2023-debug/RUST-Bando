...
function CADCanvasContent() {
  ...
  // Zoom, layer, locate and measure buttons now live on the basemap's own native
  // controls (`BasemapControls`), so they work on every tab and can't collide
  // with project docks. Zoom-to-project is still available through the
  // auto-running ZoomExtendControl; nothing here duplicates those buttons.
  return (
